...
WebUI.setText(findTestObject('LOGIN/input_email'), 'emailinvalido.com')
...
WebUI.verifyElementVisible(findTestObject('LOGIN/mensagem_email_invalido'), FailureHandling.STOP_ON_FAILURE)

WebUI.verifyTextPresent('Insira um e-mail ou número de celular válido.', true)
